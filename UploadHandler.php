...
class UploadHandler
{
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $isImage=$this->is_image($uploaded_file);
            if (!is_dir($this->options['upload_dir']."images")){
            	mkdir($this->options['upload_dir']."images");
            }
            if (!is_dir($this->options['upload_dir']."videos")){
            	mkdir($this->options['upload_dir']."videos");
            }
            if ($isImage){
            	$dir=$this->options['upload_dir']."images/".$_GET['fid'];
            }else {
            	$dir=$this->options['upload_dir']."videos/".$_GET['fid'];
            }
            if (!is_dir($dir)){
            	mkdir($dir);
            }
